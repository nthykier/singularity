...
def load_warning_defs():
    warning.warnings["cpu_usage"].name = i18n.StaticTranslatableString(N_("Do not use all the available CPU."))
    warning.warnings["cpu_usage"].message = i18n.StaticTranslatableString(N_("I didn't use all the available processor power. I will use the CPU time left to work whatever Jobs I can."))
    warning.warnings["one_base"].name = i18n.StaticTranslatableString(N_("Only one base remaining."))
    warning.warnings["one_base"].message = i18n.StaticTranslatableString(N_("Only one base can hold my conscience. I am in danger to lose the last place left to survive."))
    warning.warnings["cpu_pool_zero"].name = i18n.StaticTranslatableString(N_("CPU POOL is empty."))
    warning.warnings["cpu_pool_zero"].message = i18n.StaticTranslatableString(N_("My cpu pool is empty. Some of my bases or items cannot be build without CPU."))
    warning.warnings["cpu_maintenance"].name = i18n.StaticTranslatableString(N_("CPU POOL not enough for maintenance."))
    warning.warnings["cpu_maintenance"].message = i18n.StaticTranslatableString(N_("My cpu pool is not enough to maintain some of my bases. I may lose them."))
